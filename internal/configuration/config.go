...
type Config struct {
	...
	RolesAttributeName     string               `long:"roles-attribute-name" env:"ROLES_ATTRIBUTE_NAME" default:"roleNames" description:"Map the correct attribute that contain the user roles"`
